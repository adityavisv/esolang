...
import {
    runCortlang
} from "../interpreter_engine/cortlang"
import {
...
export const runCortlangWhole = (sourceCodeBuf, cortlangState) => (dispatch) => {
    const newCortlangState = runCortlang(sourceCodeBuf, cortlangState);
    const {
        execCode
    } = newCortlangState;
    switch (execCode) {
